...
import { 
  ...
  Thermometer, Settings, Award, Users, LucideIcon, ArrowRight
} from 'lucide-react'
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {currentCategory.services.map((service, index) => (
                  <motion.div
                    ...
                    whileHover={{ y: -5 }}
                    className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 cursor-pointer"
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: hoveredService === service ? 1 : 0.7 }}
